        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6 animate-fade-in">
            <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
              <span className="handwriting text-7xl lg:text-8xl mb-2 text-slate-900">
                Une pédagogie qui
              </span>
              <span className="block text-slate-900">s&apos;adapte à chaque</span>
              <span className="block text-slate-900">élève</span>
            </h1>

            <p className="text-lg max-w-xl leading-relaxed font-medium text-slate-700">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <Button 
                size="lg" 
                className="gap-2 text-base px-6 py-5 rounded-full bg-slate-900 hover:bg-slate-800 text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 font-medium"
              >
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="gap-2 text-base px-6 py-5 rounded-full border-2 border-slate-300 text-slate-900 bg-white hover:bg-slate-50 hover:scale-105 font-medium transition-all duration-300"
              >
          ...
          <div className="relative animate-fade-in" style={{ animationDelay: "0.3s" }}>
            <div className="absolute inset-0 bg-blue-600 opacity-5 rounded-full blur-3xl scale-125" />
