      ...
      <header className="h-16 border-b border-slate-200 bg-white sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-lg font-semibold text-slate-900">Gestion des Étudiants</h1>
              <p className="text-sm text-slate-600">Gérez les étudiants et leurs informations</p>
            </div>
          </div>
          <Button 
            variant="ghost"
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="border border-slate-200 rounded-lg overflow-hidden bg-white">
          <div className="p-6 border-b border-slate-200 bg-slate-50 flex justify-between items-center">
            <div>
              <h2 className="text-base font-semibold text-slate-900">Étudiants</h2>
              <p className="text-sm text-slate-600 mt-0.5">Liste des étudiants de l'école</p>
            </div>
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              ...
              <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                  <DialogTitle className="text-lg font-semibold text-slate-900">Ajouter un étudiant</DialogTitle>
                </DialogHeader>
